...
pub trait SymmMemTrait<T> {
    ...
    /* atomics */
    fn atomic_fetch_add(&mut self, val: T, pe: i32) -> T;
    fn atomic_add(&mut self, val: T, pe: i32);
...
impl SymmMemTrait<f32> for SymmMem<f32> {
    ...
    /* atomics */
    fn atomic_fetch_add(&mut self, _val: f32, _pe: i32) -> f32 {
        0.0
    }

    fn atomic_add(&mut self, _val: f32, _pe: i32) {}
...
impl SymmMemTrait<f64> for SymmMem<f64> {
    ...
    /* atomics */
    fn atomic_fetch_add(&mut self, _val: f64, _pe: i32) -> f64 {
        0.0
    }
    fn atomic_add(&mut self, _val: f64, _pe: i32) {}
